...
public class Runner {
    ...
    private static final String WEB_EXAMPLES_DIR = "seek";
    ...
    static class JSAuthRunner {
        public static void main(String[] args) {
            Runner.runJSExample("io/vertx/example/com.seek.soft.web/auth/server.js");
        }
    }

    static class JSAuthJDBC {
        public static void main(String[] args) {
            Runner.runJSExample("io/vertx/example/com.seek.soft.web/authjdbc/server.js");
        }
    }

    static class JSHelloWorldRunner {
        public static void main(String[] args) {
            Runner.runJSExample("io/vertx/example/com.seek.soft.web/helloworld/server.js");
        }
    }

    static class JSRealtimeRunner {
        public static void main(String[] args) { Runner.runJSExample("io/vertx/example/com.seek.soft.web/realtime/server.js"); }
    }

    static class JSChatRunner {
        public static void main(String[] args) {
            Runner.runJSExample("io/vertx/example/com.seek.soft.web/chat/server.js");
        }
    }

    static class JSSessionsRunner {
        public static void main(String[] args) {
            Runner.runJSExample("io/vertx/example/com.seek.soft.web/sessions/server.js");
        }
    }

    static class JSTemplatingRunner {
        public static void main(String[] args) {
            Runner.runJSExample("io/vertx/example/com.seek.soft.web/templating/mvel/server.js");
        }
    }
    ...
    static class GroovyAuthRunner {
        public static void main(String[] args) {
            Runner.runGroovyExample("io/vertx/example/com.seek.soft.web/auth/server.groovy");
        }
    }

    static class GroovyAuthJDBC {
        public static void main(String[] args) {
            Runner.runGroovyExample("io/vertx/example/com.seek.soft.web/authjdbc/server.groovy");
        }
    }

    static class GroovyHelloWorldRunner {
        public static void main(String[] args) {
            Runner.runGroovyExample("io/vertx/example/com.seek.soft.web/helloworld/server.groovy");
        }
    }

    static class GroovyChatRunner {
        public static void main(String[] args) { Runner.runGroovyExample("io/vertx/example/com.seek.soft.web/chat/server.groovy"); }
    }

    static class GroovyRealtimeRunner {
        public static void main(String[] args) {
            Runner.runGroovyExample("io/vertx/example/com.seek.soft.web/realtime/server.groovy");
        }
    }

    static class GroovySessionsRunner {
        public static void main(String[] args) {
            Runner.runGroovyExample("io/vertx/example/com.seek.soft.web/sessions/server.groovy");
        }
    }

    static class GroovyTemplatingRunner {
        public static void main(String[] args) {
            Runner.runGroovyExample("io/vertx/example/com.seek.soft.web/templating/mvel/server.groovy");
        }
    }

    static class GroovyRestRunner {
        public static void main(String[] args) {
            Runner.runGroovyExample("io/vertx/example/com.seek.soft.web/rest/simple_rest.groovy");
        }
    }
    ...
    static class RubyAuthRunner {
        public static void main(String[] args) {
            Runner.runRubyExample("io/vertx/example/com.seek.soft.web/auth/server.rb");
        }
    }

    static class RubyAuthJDBC {
        public static void main(String[] args) {
            Runner.runRubyExample("io/vertx/example/com.seek.soft.web/authjdbc/server.rb");
        }
    }
    static class RubyHelloWorldRunner {
        public static void main(String[] args) {
            Runner.runRubyExample("io/vertx/example/com.seek.soft.web/helloworld/server.rb");
        }
    }

    static class RubyChatRunner {
        public static void main(String[] args) { Runner.runRubyExample("io/vertx/example/com.seek.soft.web/chat/server.rb");
        }
    }

    static class RubyRealtimeRunner {
        public static void main(String[] args) {
            Runner.runRubyExample("io/vertx/example/com.seek.soft.web/realtime/server.rb");
        }
    }

    static class RubySessionsRunner {
        public static void main(String[] args) {
            Runner.runRubyExample("io/vertx/example/com.seek.soft.web/sessions/server.rb");
        }
    }

    static class RubyTemplatingRunner {
        public static void main(String[] args) {
            Runner.runRubyExample("io/vertx/example/com.seek.soft.web/templating/mvel/server.rb");
        }
    }

    public static void runExample(String exampleDir, Class clazz, VertxOptions options, DeploymentOptions
            deploymentOptions) {
        String  n = exampleDir + clazz.getPackage().getName().replace(".", "/");
